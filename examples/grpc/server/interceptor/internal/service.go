...
func interceptorServiceDesc() *grpc.ServiceDesc {
	return &grpc.ServiceDesc{
		...
		Metadata: "examples/grpc/server/interceptor",
	}
}
...
func (s *interceptorService) Ping(ctx context.Context, _ *emptypb.Empty) (*structpb.Struct, error) {
	return structpb.NewStruct(map[string]any{
		"message":     "pong",
		"interceptor": serverInterceptorValue(ctx),
	})
}
